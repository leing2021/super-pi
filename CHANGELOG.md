...
- Sourced from [ponytail](https://github.com/DietrichGebert/ponytail) (113k stars; measured -54% LOC / -20% cost / 100% safe). Out of scope by minimalism: intensity tiers, hooks/MCP distribution, standalone debt/audit skills, ledger tooling.
