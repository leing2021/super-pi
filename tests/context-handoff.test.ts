...
describe("context_handoff", () => {
  ...
  test("phase docs require shared evidence-first handoff-lite template", () => {
    ...
    // Git Context carries branch/base for diff-scope auto-detection (04-review)
    expect(pipelineConfig).toContain("## Git Context")
    expect(pipelineConfig).toContain("- branch:")
